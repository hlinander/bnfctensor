 ...
 *      bl:   length of base
 *      GS: pointer to the list of permutations forming the GS (every generator is
 *          of length n and placed consecutively in memory.)
...
extern "C" void canonical_perm_ext(int *PERM, int n,
	int SGSQ, int *base, int bl, int *GS, int m,
	int *frees, int fl,
        int *vds, int vdsl, int *dummies, int dl, int *mQ,
        int *vrs, int vrsl, int *repes, int rl,
